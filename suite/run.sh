...
./configure ${TCL_LIB:+--with-tcl="$TCL_LIB"} > configure.log
...
make testfixture CFLAGS="-O2 -DSQLITE_HAS_CODEC=1 -DSQLCIPHER_TEST=1 -DSQLITE_ENABLE_FTS5=1" > testfixture.log 2>&1
